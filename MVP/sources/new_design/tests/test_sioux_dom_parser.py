...
from MVP.sources.new_design.sioux import sioux_dom_parser
from MVP.sources.new_design.sioux import sioux_config
from MVP.sources.new_design.tests.data.dom import FakeDOMElement
from MVP.sources.new_design.types import VacancyLinks
