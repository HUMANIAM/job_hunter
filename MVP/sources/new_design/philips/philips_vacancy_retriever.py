...
from MVP.sources.new_design.philips import philips_request_factory as request_factory
from MVP.sources.new_design.philips import philips_response_parser as response_parser
from MVP.sources.new_design.types import VacancyLinkRetrievalCriteria
...
class PhilipsVacancyRetriever(vr.VacancyRetriever):
    def __init__(
        self,
    ...
    def _retrieve_listing_batch(
        ...
        retrieval_progress: vr.VacancyLinkRetrievalProgress,
    ) -> vr.VacancyLinkBatch:
