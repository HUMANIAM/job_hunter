...
from MVP.sources.new_design.sioux import sioux_config as config
from MVP.sources.new_design.sioux import sioux_dom_parser as dom_parser
...
class SiouxVacancyRetriever(vr.VacancyRetriever):
    def __init__(
        self,
    ...
    def _get_initial_cursor(
        ...
        *,
        ...
        log(f"SiouxVacancyRetriever: collected {len(facets)} discipline facets")
