...
if __package__ in {None, ""}:
    raise SystemExit(
        "Run this CLI as a module: python -m MVP.candidate_profiling.candidate_profiling_cli ..."
    )

from MVP.candidate_profiling.candidate_profiling import profile_candidate_text
